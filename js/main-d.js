...
$(document).ready(function() {
    icons.map(function(value, index, array) {
        $("#icons").append('<div data-index="' + index + '" class="icon">' +
                '<img src="' + value.image + '" onerror="this.src=\'https://lanky6.gitee.io/img/error.png\';" /><br>' +
    ...
    $("#icons .icon").dblclick(function() {
        ...
        $('body').append('<div class="panel" id="window' + windowCount + '">' +
                '<div class="panel-heading"><img class="favicon" src="'+ icon.image +'" onerror="this.src=\'https://lanky6.gitee.io/img/error.png\';" />' + 
